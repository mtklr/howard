...
command! HowardUpdateFortune :normal 1G/はい<CR>VG:!LC_ALL=C sort -df<CR>V//<CR>kdVG:s/^/%\r/e<CR>''dd
...
command! HowardUpdateJSON :normal Gk"jpVGk>?{"title":<CR>jVGk:!LC_ALL=C sort -df<CR>
